            ...
            <div className="flex flex-col space-y-8 md:flex-row md:space-x-6 md:space-y-0">
              ...
              <div className="flex flex-1 flex-col items-center text-center">
                ...
                <div className="mt-4 h-full rounded-lg border border-gray-700 bg-gray-800/50 p-4">
                  ...
                  <p className="text-gray-300">Core platform with game discovery, publishing, and user profiles.</p>
                </div>
              </div>
              ...
              <div className="flex flex-1 flex-col items-center text-center">
                ...
                <div className="mt-4 h-full rounded-lg border border-gray-700 bg-gray-800/50 p-4">
                  ...
                  <p className="text-gray-300">Creator revenue sharing, premium memberships, and game marketplace.</p>
                </div>
              </div>
            </div>
          </div>
